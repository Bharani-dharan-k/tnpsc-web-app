  ...
  <div class="container mt-5">
    <div class="row">
      ...
      <h5 class="card-title">Welcome!</h5>
                    <p class="card-text"><b>Name:</b> <?php echo $_SESSION['username']; ?></p>
                    <p class="card-text"><b>Email:</b> <?php echo $_SESSION['email']; ?></p>
                    <p class="card-text"><b>Gender</b> <?php echo $_SESSION['gender']; ?></p>
                    <p class="card-text"><b>EXAM:</b> <?php echo $_SESSION['exam']; ?></p>
      </div>
      <div class="col-md-4">
    ...
    <div class="row">
      <div class="col-md-3">
        <div class="google-drive-link">
          <h5>GROUP 1</h5>
          <a href="https://drive.google.com/file/d/1e6Fr2_eH3AovsNOugg_lIg7-L8ulkTEW/view?usp=drive_link" class="btn btn-primary">DOWNLOAD</a>
        </div>
      </div>
      <div class="col-md-3">
        <div class="google-drive-link">
        <h5>GROUP 2</h5>
          <a href="https://drive.google.com/file/d/1dJcyviiMlitR4EIA4H_1Yr5BnwfdovJz/view?usp=drive_link" class="btn btn-primary">DOWNLOAD</a>
        </div>
      </div>
      <div class="col-md-3">
        <div class="google-drive-link">
        <h5>GROUP 2a</h5>
          <a href="https://drive.google.com/file/d/1GoAK1CYvSvXhX6a1Sa1PyIi879NkfftA/view?usp=drive_link" class="btn btn-primary">DOWNLOAD</a>
        </div>
      </div>
      <div class="col-md-3">
        <div class="google-drive-link">
        <h5>GROUP 4</h5>
          <a href="https://drive.google.com/file/d/1_bT2wV7k_Sdkko-NM1ZnmW37gCtrLRTx/view?usp=drive_link" class="btn btn-primary">DOWNLOAD</a>
        </div>
      </div>
    </div>
  </div>
